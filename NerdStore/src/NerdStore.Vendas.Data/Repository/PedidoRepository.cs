...
namespace NerdStore.Vendas.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public async Task<IEnumerable<Pedido>> ObterListPorclienteId(Guid clientId)
        {
            return await _context.Pedidos.AsNoTracking().Where(p => p.ClienteId == clientId).ToListAsync();
        }
        ...
        public async Task<Voucher> ObterVoucherProCodigo(string codigo)
        {
